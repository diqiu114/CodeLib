...
#ifndef AI_DL_MODEL_H
#define AI_DL_MODEL_H
#pragma once
...
/******************************************************************************/
#define AI_DL_MODEL_MODEL_NAME          "dl_model"
#define AI_DL_MODEL_ORIGIN_MODEL_NAME   "gfm300gru30steps"

/******************************************************************************/
#define AI_DL_MODEL_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_DL_MODEL_IN_NUM        (1)
#define AI_DL_MODEL_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 30, 1, 2, 1, NULL), \
}
#define AI_DL_MODEL_IN_SIZE { \
  AI_DL_MODEL_IN_1_SIZE, \
}
#define AI_DL_MODEL_IN_SIZE_BYTES { \
  AI_DL_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_DL_MODEL_IN_1_HEIGHT      (30)
#define AI_DL_MODEL_IN_1_WIDTH       (1)
#define AI_DL_MODEL_IN_1_CHANNEL     (2)
#define AI_DL_MODEL_IN_1_SIZE        (30 * 1 * 2)
#define AI_DL_MODEL_IN_1_SIZE_BYTES  (AI_DL_MODEL_IN_1_SIZE * 4)

/******************************************************************************/
#define AI_DL_MODEL_OUT_NUM       (1)
#define AI_DL_MODEL_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 1, 1, NULL), \
}
#define AI_DL_MODEL_OUT_SIZE { \
  AI_DL_MODEL_OUT_1_SIZE, \
}
#define AI_DL_MODEL_OUT_SIZE_BYTES { \
  AI_DL_MODEL_OUT_1_SIZE_BYTES, \
}
#define AI_DL_MODEL_OUT_1_HEIGHT      (1)
#define AI_DL_MODEL_OUT_1_WIDTH       (1)
#define AI_DL_MODEL_OUT_1_CHANNEL     (1)
#define AI_DL_MODEL_OUT_1_SIZE        (1 * 1 * 1)
#define AI_DL_MODEL_OUT_1_SIZE_BYTES  (AI_DL_MODEL_OUT_1_SIZE * 4)

/******************************************************************************/
#define AI_DL_MODEL_N_NODES (4)
 ...
 * @ref ai_dl_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_dl_model_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_DL_MODEL_*
 * defines into file @ref dl_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context

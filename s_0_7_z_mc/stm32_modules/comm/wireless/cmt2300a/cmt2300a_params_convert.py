...
def cmt2300a_convert_hex(strSrcFile, strDstFile, strSubfix):
  ...
  output.write('const unsigned char g_cmt2300aCmtBank' +strSubfix+ '[CMT2300A_CMT_BANK_SIZE] = {\r\n')
  ...
  output.write('const unsigned char g_cmt2300aSystemBank' +strSubfix+ '[CMT2300A_SYSTEM_BANK_SIZE] = {\r\n')
  ...
  output.write('const unsigned char g_cmt2300aFrequencyBank' +strSubfix+ '[CMT2300A_FREQUENCY_BANK_SIZE] = {\r\n')
  ...
  output.write('const unsigned char g_cmt2300aDataRateBank' +strSubfix+ '[CMT2300A_DATA_RATE_BANK_SIZE] = {\r\n')
  ...
  output.write('const unsigned char g_cmt2300aBasebandBank' +strSubfix+ '[CMT2300A_BASEBAND_BANK_SIZE] = {\r\n')
  ...
  output.write('const unsigned char g_cmt2300aTxBank' +strSubfix+ '[CMT2300A_TX_BANK_SIZE] = {\r\n')
...
cmt2300a_convert_hex( abs_path + '\\cmt2300a_params.exp', abs_path + '\\cmt2300a_params.h', '')